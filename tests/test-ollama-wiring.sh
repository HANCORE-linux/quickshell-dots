...
assert_contains versions/V1/modules/OllamaData.qml 'readonly property alias operations: modelOperations'
assert_contains versions/V1/modules/OllamaData.qml 'property alias operationInProgress: modelOperations.operationInProgress'
assert_contains versions/V1/modules/OllamaData.qml 'readonly property bool controlsLocked:'
assert_contains versions/V1/modules/OllamaData.qml 'readonly property alias config: runtimeConfig'
...
assert_not_contains versions/V1/modules/OllamaData.qml 'id: runtimeConfigFile'
assert_not_contains versions/V1/modules/OllamaData.qml 'id: runtimeConfigEditProc'
assert_contains versions/V1/modules/OllamaRuntimeConfig.qml 'property var selectedKeepAlive: "5m"'
assert_contains versions/V1/modules/OllamaRuntimeConfig.qml 'property var selectedNumCtx: null'
assert_contains versions/V1/modules/OllamaRuntimeConfig.qml 'property bool dirty: false'
assert_contains versions/V1/modules/OllamaRuntimeConfig.qml 'id: runtimeConfigFile'
assert_contains versions/V1/modules/OllamaRuntimeConfig.qml 'id: runtimeConfigEditProc'
assert_contains versions/V1/modules/OllamaRuntimeConfig.qml 'function setKeepAlive(value)'
assert_contains versions/V1/modules/OllamaRuntimeConfig.qml 'function setNumCtx(value)'
assert_contains versions/V1/modules/OllamaRuntimeConfig.qml 'function save()'
assert_contains versions/V1/modules/OllamaRuntimeConfig.qml 'function reload()'
assert_contains versions/V1/modules/OllamaRuntimeConfig.qml 'function openEditor()'
assert_contains versions/V1/modules/OllamaModelOperations.qml 'OllamaDataLogic.buildLoadPayload(modelName, 0, null)'
assert_contains versions/V1/modules/OllamaModelOperations.qml 'buildLoadPayload(pendingModel)'
...
assert_contains versions/V1/modules/OllamaData.qml 'property alias operationError: modelOperations.operationError'
assert_contains versions/V1/modules/OllamaData.qml 'property alias actionError: modelOperations.actionError'
...
assert_contains versions/V1/modules/OllamaData.qml 'OllamaModelOperations {'
for process_id in operationPsProc unloadProc loadProc; do
    assert_not_contains versions/V1/modules/OllamaData.qml "id: $process_id"
    assert_contains versions/V1/modules/OllamaModelOperations.qml "id: $process_id"
done
assert_contains versions/V1/modules/OllamaModelOperations.qml 'signal loadedModelsAccepted(var models)'
assert_contains versions/V1/modules/OllamaModelOperations.qml 'signal tagsRefreshRequested()'
assert_contains versions/V1/modules/OllamaModelOperations.qml 'signal loadedRefreshRequested()'
assert_contains versions/V1/modules/OllamaModelOperations.qml 'signal configurationApplied()'
...
assert_file_order versions/V1/panels/OllamaPanel.qml \
    ...
    'OllamaPullSection {' \
    'OllamaConfigSection {'
assert_contains versions/V1/panels/ollama/OllamaSummarySection.qml 'visible: summarySection.data.operations.operationInProgress'
assert_contains versions/V1/panels/ollama/OllamaSummarySection.qml 'text: summarySection.data.operations.operationMessage'
assert_contains versions/V1/panels/ollama/OllamaSummarySection.qml 'summarySection.data.config.selectedNumCtx'
assert_contains versions/V1/panels/ollama/OllamaModelRow.qml 'enabled: !modelRow.data.controlsLocked'
assert_contains versions/V1/panels/OllamaPanel.qml 'data: root.ollama.operations'
assert_contains versions/V1/panels/OllamaPanel.qml 'root.ollama.operations.loadModel(name)'
assert_contains versions/V1/panels/OllamaPanel.qml 'root.ollama.operations.ejectModel(name)'
...
assert_contains versions/V1/panels/OllamaPanel.qml 'data: root.ollama.config'
assert_contains versions/V1/panels/OllamaPanel.qml 'root.ollama.config.setKeepAlive'
assert_contains versions/V1/panels/OllamaPanel.qml 'root.ollama.config.setNumCtx'
...
assert_file_matches versions/V1/panels/OllamaPanel.qml 'function setKeepAlive\(value\)\s*\{\s*clearDeleteConfirmation\(\)\s*root\.ollama\.config\.setKeepAlive\(value\)'
...
assert_contains versions/V1/panels/OllamaPanel.qml 'root.ollama.config.openEditor()'
...
assert_contains versions/V1/panels/OllamaPanel.qml 'root.ollama.operations.deleteModel(name)'
...
assert_file_matches versions/V1/panels/ollama/OllamaConfigSection.qml 'property bool selected: configSection\.data\.selectedKeepAlive\s*=== modelData\.value[\s\S]*?property bool chipEnabled: !configSection\.controlsLocked[\s\S]*?hoverEnabled: enabled[\s\S]*?cursorShape: enabled \? Qt\.PointingHandCursor : Qt\.ArrowCursor'
assert_file_matches versions/V1/panels/ollama/OllamaConfigSection.qml 'property bool isCustom: modelData\.value === "custom"[\s\S]*?property bool chipEnabled: !configSection\.controlsLocked[\s\S]*?width: isCustom \? 52 : 40[\s\S]*?horizontalAlignment: Text\.AlignHCenter'
