...
assert_contains versions/V1/modules/OllamaData.qml 'stopProc.command = ["env", "OLLAMA_HOST=" + baseUrl, "ollama", "stop", modelName]'
assert_contains versions/V1/modules/OllamaData.qml 'keep_alive: -1'
assert_contains versions/V1/modules/OllamaData.qml 'stream: false'
assert_contains versions/V1/modules/OllamaData.qml 'if (operationInProgress || loadedProc.running) return'
...
assert_contains versions/V1/modules/OllamaData.qml 'if (operationInProgress || tagsProc.running) return'
