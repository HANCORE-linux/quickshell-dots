...
assert_file_matches versions/V1/panels/OllamaPanel.qml 'id: modelDelete[\s\S]*?anchors\.rightMargin: 8[\s\S]*?anchors\.top: parent\.top[\s\S]*?anchors\.topMargin: 15'
assert_file_matches versions/V1/panels/OllamaPanel.qml 'id: modelReload[\s\S]*?anchors\.rightMargin: 8[\s\S]*?anchors\.top: parent\.top[\s\S]*?anchors\.topMargin: 15'
assert_file_matches versions/V1/panels/OllamaPanel.qml 'id: modelAction[\s\S]*?anchors\.rightMargin: 8[\s\S]*?anchors\.top: parent\.top[\s\S]*?anchors\.topMargin: 15'
...
assert_file_matches versions/V1/panels/OllamaPanel.qml 'id: modelDelete[\s\S]*?width: 28[\s\S]*?height: 28[\s\S]*?id: modelDeleteGlyph[\s\S]*?width: 18[\s\S]*?height: 18[\s\S]*?horizontalAlignment: Text\.AlignHCenter[\s\S]*?verticalAlignment: Text\.AlignVCenter'
assert_file_matches versions/V1/panels/OllamaPanel.qml 'id: configurationHeadingGroup[\s\S]*?anchors\.centerIn: parent[\s\S]*?id: configurationHeadingLabel[\s\S]*?text: "Configuration"[\s\S]*?id: configurationDisclosureIndicator[\s\S]*?width: 12[\s\S]*?text: ollamaPanel\.configOpen \? "▾" : "▸"'
assert_not_contains versions/V1/panels/OllamaPanel.qml 'text: ollamaPanel.configOpen ? "Configuration  ▾" : "Configuration  ▸"'
