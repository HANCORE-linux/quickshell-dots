...
ShellRoot {
    ...
    Component.onCompleted: {
        ...
        check(data.config !== null, "config controller")
        check(typeof data.config.setKeepAlive === "function", "config setKeepAlive method")
        check(typeof data.config.setNumCtx === "function", "config setNumCtx method")
        check(typeof data.config.save === "function", "config save method")
        check(typeof data.config.reload === "function", "config reload method")
        check(typeof data.config.openEditor === "function", "config openEditor method")
